...
const LANG_PT_BR = {
	...
	dev_desc: "Focado em tecnologias disruptivas tais como: Inteligência Artificial, Machine Learning, Criptomoedas, soluções Linux, soluções ARM, criptografia (ECDSA, ECDH, AES, RSA), IoT, Automação industrial e residencial, desenvolvimento C e Assembly, aplicativos web (node.js, Python e PHP), NoSQL, SQL, projetos de placas PCB, Azure, Amazon, Google Cloud, IBM Bluemix, circuitos elétricos e magnéticos",
	...
	whoami1: "Sou um chatbot que integra tecnologias disruptivas tais como Machine Learning, IoT, Nuvem e API's como: cotação de moedas, criptomoedas, previsão do tempo (em desenvolvimento), serviços em nuvem entre outros",
...
const LANG_EN_US = {
	...
	dev_desc: "Interested into disruptive technologies: Artificial Intelligence, Machine Learning, cryptocurrencies, Linux and ARM solutions, (ECDSA, ECDH, AES, RSA) cryptograpy, IoT, Industrial and home automation, C and Assembly languages, Webapplication (Node.JS, Python and PHP), NoSQL, SQL, PCB hardware design, Azure, Amazon, Google Cloud, electric and magnetics circuits",
	dev_email_contact: "fabioegel@gmail.com",
	...
	whoami1: "I am a chatbot on which integrates disruptive technologies such as Artificial Intelligence, Machine Learning, IoT, Cloud Services and API's like coin price, cryptocurrencies prices, wheather forecast (in development) et. al.",
